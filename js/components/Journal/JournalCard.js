...
export default (journal, svg, journalList) => {
    journal.forEach((entry) => {
        ...
        ratingStarsSvg.classList.add('journal-entry__star') // @TODO kann noch in die createSvg-Funktion verschoben werden
        for (let i = 1; i < 6; i++) {
        ...
        rectangleSvg.classList.add('journal-entry__icon') // @TODO kann noch in die createSvg-Funktion verschoben werden
        for (let i = 1; i < 11; i++) {
